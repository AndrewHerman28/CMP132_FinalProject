...
class PlinkoGame:
    ...
    def start_plinko(self):
        ...
        self.display_congratulations(value)
    ...
    def display_congratulations(self, score):
        congratulations_messages = [
            "Congratulations! You're a Plinko champion!",
            "Wow! What a score! Well done!",
            "Fantastic! You really know how to play Plinko!",
            "Incredible! You nailed it!",
        ]

        congratulatory_message = random.choice(congratulations_messages)
        messagebox.showinfo("Congratulations!", f"Your score: {score}\n{congratulatory_message}")
...
# Import messagebox from tkinter for displaying messages
